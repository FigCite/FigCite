...
def ChartProperties(x,y,N,p):
    ...
    chartFeatures = [XLabel,YLabel,xposX,yposX,xposY,yposY,legXLoc,legYLoc,legbboxX,legbboxY,fontrand,xtickMax,xtickgrp,xstep,ytickMax,ytickgrp,ystep,rotationXTicks,rotationYTicks]
    return XLabel,YLabel,xposX,yposX,xposY,yposY,legXLoc,legYLoc,legbboxX,legbboxY,fontrand,xtickMax,xtickgrp,xstep,ytickMax,ytickgrp,ystep,rotationXTicks,rotationYTicks
...
def LineChartPlot(x,y,N,count):
    ...
    XLabel,YLabel,xposX,yposX,xposY,yposY,legXLoc,legYLoc,legbboxX,legbboxY,fontrand,xtickMax,xtickgrp,xstep,ytickMax,ytickgrp,ystep,rotationXTicks,rotationYTicks = ChartProperties(x,y,N,p)
    ...
    leg = plt.legend(handles= p, loc = (legXLoc,legYLoc),fontsize = fontrand)
    ...
    print (bbox_legend)
    plt.tight_layout()
    plt.savefig(("LineCharts/"+str(N)+"_line_"+str(count)+".png"),dpi=mydpi*10)#,bbox_inches ="tight")
